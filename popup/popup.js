                    ...
                    l()(t, [
                        {
                            ...
                            value: function () {
                                ...
                                if (null !== t) {
                                    ...
                                    fetch("https://raw.githubusercontent.com/Lumm1t/anti-testportal/master/public/manifest.json")
                                        .then(
                                            (function () {
                                                var t = a()(
                                        ...
                                        .then(function (e) {
                                            var n = e.version;
                                            t.textContent = r === n ? "up to date (".concat(r, ")") : "update available (".concat(n, ")");
                                        });
                                }
                            },
                        },
    ...
    function (t, r, e) {
        var n = (function (t) {
            ...
            function b(t, r) {
                ...
                return o
                    ? o.done
                        ? ((r[t.resultName] = o.value), (r.next = t.nextLoc), "return" !== r.method && ((r.method = "next"), (r.arg = void 0)), (r.delegate = null), l)
                        : o
                    ...
                    (E.prototype = {
                        ...
                        finish: function (t) {
                            for (var r = this.tryEntries.length - 1; r >= 0; --r) {
                                ...
                                if (e.finallyLoc === t) return this.complete(e.completion, e.afterLoc), L(e), l;
                            }
                        },
                        catch: function (t) {
                            for (var r = this.tryEntries.length - 1; r >= 0; --r) {
                        ...
                        delegateYield: function (t, r, e) {
                            return (this.delegate = { iterator: j(t), resultName: r, nextLoc: e }), "next" === this.method && (this.arg = void 0), l;
                        },
                    }),
                    t
            );
